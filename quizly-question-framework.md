# Quizly Onboarding Architecture: 5-Pillar Question Framework
...
```mermaid
flowchart TD
    subgraph UserInteraction ["User Experience (5 Pillars)"]
        ...
        P5["Pillar 5: Commercial & Conversion Calibration"]
    end
...
| **Q4.2a: Design Direction** | *"Which design direction feels most like your personal style?"* | • **Timeless and classic (heritage shapes, aviators, wayfarers)** (`axis_family_classic`)<br>• **Bold and architectural (heavy volume, sharp geometry, high-tech)** (`axis_family_bold`)<br>• **Refined and sculptural (fine wire, or expressive curves)** (`axis_family_refined`) | Narrows the 7 design axes to one family. Needed because `singleChoice` caps at 4 options. |
| **Q4.2b: Design Axis** *(asked after Q4.2a, options depend on the family chosen)* | *"Which of these feels closest to your taste?"* | **classic:** Heritage & Timeless Vintage (`axis_heritage`), Classic Aviation (`axis_aviator`), Effortless Mid-Century Cool (`axis_wayfarer`)<br>**bold:** Architectural & Bold Brutalism (`axis_architectural`), Cybernetic & High-Tech (`axis_cybernetic`)<br>**refined:** Minimalist & Intellectual (`axis_minimalist`), Sensual & Sculptural (`axis_sensual`) | Maps directly to archetypal design lineages (Module 7) and physical silhouette families. |
...
| **Q5.3: Budget Bracket** | *"What's your budget for a pair you'll wear every day?"* | • **Under $80** (`budget_under_80`)<br>• **$80 to $150** (`budget_80_150`)<br>• **$150 to $250** (`budget_150_250`)<br>• **Whatever it takes, if they fit** (`budget_open`) | Hard price filter on catalog datastore query. **Excluded from the live funnel:** every catalog SKU prices $129 to $185, so `budget_under_80` filters to an empty result set. Rebracket against catalog pricing before asking this. |
...
export class NextQuestionResponseDto {
  nextQuestion: QuestionDto | null; // null when the 8-question funnel is complete
}
```

### Complete Diagnostic Catalog (JSON)

> This catalog and section 4 of [`pulumi/agent/prompt.md`](pulumi/agent/prompt.md) are the same data. Change both together.
> `Q4.2` is split into `Q4.2a` (axis family) and `Q4.2b` (axis within that family) because `singleChoice` caps at 4 options and there are 7 axes.
> `Q5.3` (budget) is documented but excluded from the live funnel, see its `excludedFromFunnel` note.
...
[
    ...
    "choices": [
      {
        ...
        "value": "vertical_dominant"
      },
      {
        "label": "About equal",
        "value": "balanced_ratio"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Defined and angular",
        "value": "jaw_angular"
      },
      {
        "label": "Soft and rounded",
        "value": "jaw_soft"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Forehead and cheekbones, my chin tapers",
        "value": "taper_to_chin"
      },
      {
        "label": "About the same all the way down",
        "value": "uniform_width"
      },
      {
        "label": "My jaw is the widest part",
        "value": "jaw_dominant"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Too tight, they pinch my temples",
        "value": "width_tight"
      },
      {
        "label": "About right",
        "value": "width_standard"
      },
      {
        "label": "Too wide, they slide or look oversized",
        "value": "width_wide"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "They sit right along my browline",
        "value": "brow_aligned"
      },
      {
        "label": "They completely cover my eyebrows",
        "value": "brow_covered"
      },
      {
        "label": "My eyebrows stick out far above the frame",
        "value": "brow_exposed"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Low or flatter bridge (frames often sit on cheeks)",
        "value": "bridge_low_asian_fit"
      },
      {
        "label": "High and narrow bridge (frames often pinch or sit high)",
        "value": "bridge_high_narrow"
      },
      {
        "label": "Standard or average bridge",
        "value": "bridge_standard"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "High contrast (e.g. dark hair with fair skin, or striking bright eyes)",
        "value": "contrast_high"
      },
      {
        "label": "Warm and golden (olive, honey, amber, or bronze undertones)",
        "value": "contrast_warm"
      },
      {
        "label": "Soft and low contrast (tones blend smoothly, muted or monochrome)",
        "value": "contrast_muted"
      },
      {
        "label": "Deep and rich (deep skin and hair with uniform intensity)",
        "value": "contrast_deep"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "They looked great in the mirror, but felt like 'too much' in real life",
        "value": "regret_overpowering"
      },
      {
        "label": "Discomfort: they started aching or slipping after 30 minutes",
        "value": "regret_discomfort"
      },
      {
        "label": "They felt generic and didn't feel like 'me' after a few wears",
        "value": "regret_impersonal"
      },
      {
        "label": "They scratched or felt flimsy way too quickly",
        "value": "regret_fragility"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "They slide down my nose constantly",
        "value": "bridge_slipping"
      },
      {
        "label": "They leave red pinch marks on my nose",
        "value": "bridge_pressure"
      },
      {
        "label": "They sit too high, above my eyebrows",
        "value": "bridge_too_high"
      },
      {
        "label": "No issues, they fit fine",
        "value": "bridge_fine"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Yes, they lift off my nose or fog up",
        "value": "cheek_contact_yes"
      },
      {
        "label": "No, there's a clear gap",
        "value": "cheek_contact_no"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Headache, or soreness behind my ears",
        "value": "fatigue_temple_bite"
      },
      {
        "label": "Heavy and tired across the bridge",
        "value": "fatigue_bridge_load"
      },
      {
        "label": "They creep forward when I look down",
        "value": "fatigue_forward_slip"
      },
      {
        "label": "Nothing, no discomfort",
        "value": "fatigue_none"
      }
    ]
  },
    ...
    "choices": [
      {
        ...
        "value": "lash_smear_yes"
      },
      {
        "label": "Only with some pairs",
        "value": "lash_smear_sometimes"
      },
      {
        "label": "Never noticed",
        "value": "lash_smear_no"
  ...
  },
  {
    ...
    "choices": [
      {
        "label": "Must be featherlight — I dislike feeling frames",
        "value": "weight_featherlight"
      },
      {
        "label": "I prefer a solid, substantial feel (feels premium)",
        "value": "weight_substantial"
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "label": "Yes, caps/hats often push top of frames down",
        "value": "headwear_cap_hat"
      },
      {
        "label": "Yes, helmets or headphones squeeze the temple arms",
        "value": "headwear_helmet_headphones"
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "label": "City and everyday, commuting, terraces",
        "value": "env_city"
      },
      {
        "label": "Water, beach, boating, snow",
        "value": "env_high_glare"
      },
      {
        "label": "Driving and road trips",
        "value": "env_driving"
      },
      {
        "label": "Running, cycling, training",
        "value": "env_sport"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Constantly, even on ordinary days",
        "value": "glare_severe"
      },
      {
        "label": "On bright days",
        "value": "glare_moderate"
      },
      {
        "label": "Rarely",
        "value": "glare_low"
  ...
  },
  {
    ...
    "choices": [
      {
        "label": "Yes, I keep them on moving indoors or into shade",
        "value": "lighting_transition_wear"
      },
      {
        "label": "Strictly bright outdoor daylight",
        "value": "lighting_bright_only"
      },
      {
        "label": "I love wearing them during golden hour and sunset",
        "value": "lighting_golden_hour"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Must accommodate prescription lenses (Rx)",
        "value": "rx_needed"
      },
      {
        "label": "Standard non-prescription sun lenses",
        "value": "rx_plano"
      },
      {
        "label": "Open to optical clip-ons or adapters",
        "value": "rx_clipon"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Approachable, warm, and easy to talk to",
        "value": "persona_approachable"
      },
      {
        "label": "Effortlessly composed and quietly understated",
        "value": "persona_understated"
      },
      {
        "label": "Commanding, mysterious, and untouchable",
        "value": "persona_commanding"
      },
      {
        "label": "Creative, artistic, and unapologetically bold",
        "value": "persona_expressive"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Fully dark, nobody sees my eyes",
        "value": "tint_opaque"
      },
      {
        "label": "Classic dark, standard sun protection",
        "value": "tint_classic"
      },
      {
        "label": "Lighter gradient, my eyes still read",
        "value": "tint_gradient"
      },
      {
        "label": "Tinted and expressive: amber, rose, blue",
        "value": "tint_expressive"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Harmonious extension: subtle, compliments my natural facial contours",
        "value": "presence_subtle"
      },
      {
        "label": "The focal point: a distinct statement that defines my look",
        "value": "presence_statement"
      }
    ]
  },
  {
    "id": "Q4.2a",
    "pillar": "style_semiotics",
    "question": "Which design direction feels most like your personal style?",
    "typeOfQuestion": "singleChoice",
    "choices": [
      {
        "label": "Timeless and classic (heritage shapes, aviators, wayfarers)",
        "value": "axis_family_classic"
      },
      {
        "label": "Bold and architectural (heavy volume, sharp geometry, high-tech)",
        "value": "axis_family_bold"
      },
      {
        "label": "Refined and sculptural (fine wire, or expressive curves)",
        "value": "axis_family_refined"
      }
    ]
  },
  {
    ...
    "pillar": "style_semiotics",
    "askAfter": "Q4.2a",
    "whenQ42aValue": "axis_family_classic",
    "question": "Which of these feels closest to your taste?",
    "typeOfQuestion": "singleChoice",
    "choices": [
      {
        "label": "Heritage & Timeless Vintage (Havana tortoise, retro panto, Riviera cool)",
        "value": "axis_heritage"
      },
      {
        "label": "Classic Aviation (Gold teardrop aviator with double brow bar)",
        "value": "axis_aviator"
      },
      {
        "label": "Effortless Mid-Century Cool (Crisp black acetate wayfarer)",
        "value": "axis_wayfarer"
      }
    ]
  },
  {
    ...
    "pillar": "style_semiotics",
    "askAfter": "Q4.2a",
    "whenQ42aValue": "axis_family_bold",
    "question": "Which of these feels closest to your taste?",
    "typeOfQuestion": "singleChoice",
    "choices": [
      {
        "label": "Architectural & Bold Brutalism (Heavy slab acetate, sharp geometric flat-top)",
        "value": "axis_architectural"
      },
      {
        "label": "Cybernetic & High-Tech (Matte carbon, high-wrap mono-shield)",
        "value": "axis_cybernetic"
      }
    ]
  },
  {
    ...
    "pillar": "style_semiotics",
    "askAfter": "Q4.2a",
    "whenQ42aValue": "axis_family_refined",
    "question": "Which of these feels closest to your taste?",
    "typeOfQuestion": "singleChoice",
    "choices": [
      {
        "label": "Minimalist & Intellectual (Featherweight titanium wire, clean Bauhaus circles)",
        "value": "axis_minimalist"
      },
      {
        "label": "Sensual & Sculptural (Upswept cat-eye, translucent honey crystals)",
        "value": "axis_sensual"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Reflective flash mirror (high privacy & maximum glare block)",
        "value": "lens_mirror"
      },
      {
        "label": "Classic plain tint (natural, clean look without reflection)",
        "value": "lens_plain"
      },
      {
        "label": "Subtle semi-reflective sheen",
        "value": "lens_semi_mirror"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Lens quality and protection",
        "value": "priority_optics"
      },
      {
        "label": "A fit that stays put",
        "value": "priority_fit"
      },
      {
        "label": "The look",
  ...
  },
  {
    ...
    "choices": [
      {
        "label": "Classic Black or Dark Matte (sleek & versatile)",
        "value": "palette_black_monochrome"
      },
      {
        "label": "Warm Tortoise or Gold Metals (rich & timeless)",
        "value": "palette_tortoise_gold"
      },
      {
        "label": "Cool Silver, Titanium, or Gunmetal (modern & crisp)",
        "value": "palette_silver_titanium"
      },
      {
        "label": "Translucent Crystal or Expressive Tones (rose, amber, honey)",
        "value": "palette_crystal_expressive"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Zero logos — unbranded quiet luxury",
        "value": "branding_minimal_quiet"
      },
      {
        "label": "Subtle micro-engravings or hardware accents",
        "value": "branding_subtle_details"
      },
      {
        "label": "Bold logo or signature icon",
        "value": "branding_statement"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "Instantly elevated and put-together, even in a t-shirt",
        "value": "aspiration_elevated"
      },
      {
        "label": "Shielded from the world with private confidence",
        "value": "aspiration_shielded"
      },
      {
        "label": "Ready for outdoor action without babysitting delicate frames",
        "value": "aspiration_carefree"
      },
      {
        "label": "Like the best, most stylish version of myself",
        "value": "aspiration_signature"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "This year",
        "value": "recency_this_year"
      },
      {
        "label": "One to two years ago",
        "value": "recency_1_2_years"
      },
      {
        "label": "Longer than I can remember",
        "value": "recency_long_ago"
      },
      {
        "label": "Never, I grab whatever's cheap",
        "value": "recency_never"
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "label": "This week, I have something coming up",
        "value": "urgency_week"
      },
      {
        "label": "This month",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "label": "$150 to $250",
        "value": "budget_150_250"
      },
      {
        "label": "Whatever it takes, if they actually fit",
        "value": "budget_open"
      }
    ],
    "excludedFromFunnel": "Catalog prices run $129 to $185, so these brackets would filter to an empty result set. Rebracket before asking."
  },
  {
    "id": "Q5.4",
    "pillar": "commercial",
    ...
    "choices": [
      {
        "label": "My primary everyday driver",
        "value": "role_daily_driver"
      },
      {
        "label": "A specialized pair for a specific activity or trip",
        "value": "role_activity_travel"
      },
      {
        "label": "A stylish accent piece to rotate in",
        "value": "role_style_accent"
      },
      {
